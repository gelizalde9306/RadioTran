        ...
        <div class="image">
          <?php
              if($_SESSION["foto"]  != ""){
                ...
                echo '<img src="views/img/usuarios/default/anonymous.png" class="img-circle elevation-2" alt="User Image">';
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="registrarEstaciones" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Registrar Transmisión </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="listarTransmisiones" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Otras Transmisiones</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="modificarTransmisiones" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Administrar</p>
                </a>
              </li>
